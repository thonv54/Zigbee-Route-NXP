...
#define ZPS_NODE_AN1184_ZBP_ROUTER
...
#define HOME_AUTOMATION_POWERPROFILE_CLUSTER_ID    (0x001a)
#define HOME_AUTOMATION_METTERIDENTIFICATION_CLUSTER_ID    (0x0b01)
#define HOME_AUTOMATION_APPLIANCESTATISTICS_CLUSTER_ID    (0x0b03)
#define HOME_AUTOMATION_SIMPLEMETERING_CLUSTER_ID    (0x0702)

/* Node 'AN1184_ZBP_Coordinator' */
/* Endpoints */
#define AN1184_ZBP_COORDINATOR_ZDO_ENDPOINT    (0)
#define AN1184_ZBP_COORDINATOR_COORDINATOR_ENDPOINT_ENDPOINT    (1)

/* Node 'AN1184_ZBP_Router' */

/* Endpoints */
#define AN1184_ZBP_ROUTER_ZDO_ENDPOINT    (0)
#define AN1184_ZBP_ROUTER_LIGHT1_ENDPOINT_ENDPOINT    (1)
#define AN1184_ZBP_ROUTER_SWITCH1_ENDPOINT_ENDPOINT    (2)
#define AN1184_ZBP_ROUTER_LIGHT2_ENDPOINT_ENDPOINT    (3)
#define AN1184_ZBP_ROUTER_SWITCH2_ENDPOINT_ENDPOINT    (4)

/* Node 'AN1184_ZBP_SleepingEndDevice' */

/* Endpoints */
#define AN1184_ZBP_SLEEPINGENDDEVICE_ZDO_ENDPOINT    (0)
#define AN1184_ZBP_SLEEPINGENDDEVICE_MYENDPOINT_ENDPOINT    (1)
